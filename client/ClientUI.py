...
class ClientUI(EventEmitter):
  ...
  def __init__(self):
    ...
    root_container = HSplit([
        ...
        TextArea(dont_extend_height=True, scrollbar=True, multiline=False, accept_handler=lambda buf: self._on_buffer_submit(buf))
    ])
  ...
  async def ask_for(self, *args, **kwargs):
    """
