...
def packet_factory(buffer: bytes):
    """ 
    Factory function to create and return a specific instance of Packet subclass and its length in bytes from a buffer of data.
    Only the first packet found in the buffer is returned. To get the rest of the packets, call it with a smaller buffer.
